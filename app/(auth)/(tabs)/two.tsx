  ...
  return (
    <View style={styles.container}>
      <View style={styles.textContainer}>
        <Text style={styles.title}>YVR Management Platform</Text>
      </View>
      ...
      <View style={styles.buttonContainer}>
        ...
        <View style={styles.buttonRow}>
          <TouchableOpacity
            style={styles.button}
            onPress={() =>
              navigation.navigate("pages", { context: "Status page" })
            }
          >
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() =>
              navigation.navigate("pages", { context: "Event page" })
            }
          >
            <MaterialIcons
              name="event"
        ...
        <View style={styles.buttonRow}>
          <TouchableOpacity
            style={styles.button}
            onPress={() =>
              navigation.navigate("pages", { context: "Statistics page" })
            }
          >
            <MaterialIcons
              name="analytics"
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() =>
              navigation.navigate("pages", { context: "Manual page" })
            }
          >
            <MaterialIcons
              name="assignment"
        ...
        <View style={styles.buttonRow}>
          <TouchableOpacity
            style={styles.button}
            onPress={() =>
              navigation.navigate("pages", { context: "Number page" })
            }
          >
            <MaterialIcons
              name="phone"
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() =>
              navigation.navigate("pages", { context: "Schedule page" })
            }
          >
            <MaterialIcons
              name="schedule"
