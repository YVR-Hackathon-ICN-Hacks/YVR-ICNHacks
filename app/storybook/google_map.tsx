...
export default function GoogleMap() {
    ...
    const handlePress = async (data: GooglePlaceData, details: GooglePlaceDetail | null) => {
                    ...
                    <View style={styles.infoContainer}>
                        ...
                        <View>
                            ...
                            {selectedPlace.phone_number && (
                                <Text style={styles.infoText}>Phone Number: {selectedPlace.phone_number}</Text>
                            )}
                            {selectedPlace.rating && (
                                <Text style={styles.infoText}>Rating: {selectedPlace.rating}</Text>
                            )}
                        </View>
                    </View>
                )}
